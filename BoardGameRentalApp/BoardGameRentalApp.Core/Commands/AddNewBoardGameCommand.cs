...
{
    public class AddNewBoardGameCommand : CommandBase
    {
        ...
        public AddNewBoardGameCommand(Action myAction, Func<bool> canExecuteEvent, ListOfBoardGamesViewModel viewModelBase):base(myAction)
        {
            MyAction = myAction;
